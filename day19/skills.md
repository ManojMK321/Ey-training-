...
```
outputs/
├── healthcare_financial_model.xlsx   
├── legal_contract.docx               
├── edtech_pitch.pptx                 
...
*Generated using Claude Sonnet 4.6 with the SKILL.md framework. All demo content is fictional and for assessment purposes only.*
